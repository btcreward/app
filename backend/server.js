...
const startServer = async () => {
  ...
  server.listen(PORT, () => {
    ...
    console.log('\x1b[33m%s\x1b[0m', '🔗 Base URL:', `https://btcreward-backend.onrender.com`);
    console.log('\x1b[35m%s\x1b[0m', '📊 Health Check:', `https://btcreward-backend.onrender.com/health`);
    console.log('----------------------------------------\n');
  });
};
